...
// AMŽIUS
// const schoolHummanAge = prompt("Įveskite vaiko amžių:")
// const numericAge = Number(schoolHummanAge)
...
//         console.log(
//             "Patekai i kita lygi: pirmas ir antras atsakymai buvo teisingi, o trecias buvo neteisingas.",
//         )
//     } else if(userAnswer1 === 6 && userAnswer2 !== 7 && userAnswer3 === 8) {
//         console.log(
//             "Patekai i kita lygi: pirmas ir trecias atsakymai buvo teisingi, o antras buvo neteisingas.",
//         )
//     } else if(userAnswer1 !== 6 && userAnswer2 === 7 && userAnswer3 === 8) {
//         console.log(
//             "Patekai i kita lygi: antras ir trecias atsakymai buvo teisingi, o pirmas buvo neteisingas.",
//         )
//     } else if(userAnswer1 === 6 && userAnswer2 !== 7 && userAnswer3 !== 8) {
//         console.log(
//             "Nepatekai i kita lygi: pirmas atsakymas buvo teisingas, o kiti buvo neteisingi.",
//         )
//     } else if(userAnswer1 !== 6 && userAnswer2 === 7 && userAnswer3 !== 8) {
//         console.log(
//             "Nepatekai i kita lygi: antras atsakymas buvo teisingas, o kiti buvo neteisingi.",
//         )
//     } else if(userAnswer1 !== 6 && userAnswer2 !== 7 && userAnswer3 === 8) {
//         console.log(
//             "Nepatekai i kita lygi: trecias atsakymas buvo teisingas, o kiti buvo neteisingi.",
//         )
//     } else {
